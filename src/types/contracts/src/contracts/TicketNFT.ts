...
export interface TicketNFTInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "ticketData", data: BytesLike): Result;
...
export namespace TicketMintedEvent {
  ...
  export type OutputTuple = [tokenId: bigint, to: string, tierId: bigint];
  export interface OutputObject {
    tokenId: bigint;
    to: string;
    tierId: bigint;
...
export interface TicketNFT extends BaseContract {
  ...
  mint: TypedContractMethod<
    [to: AddressLike, tierId: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  ticketData: TypedContractMethod<
    [arg0: BigNumberish],
    [
  ...
  updatePerks: TypedContractMethod<
    [tokenId: BigNumberish, perks: string],
    [void],
    "nonpayable"
  >;
