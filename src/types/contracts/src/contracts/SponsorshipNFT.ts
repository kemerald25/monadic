...
export interface SponsorshipNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface SponsorshipNFT extends BaseContract {
  connect(runner?: ContractRunner | null): SponsorshipNFT;
  waitForDeployment(): Promise<this>;

  interface: SponsorshipNFTInterface;
  ...
  tokenTotalSupply: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "tokenTotalSupply"
  ...
  filters: {
    ...
    "SponsorshipMinted(address,uint256,uint256)": TypedContractEvent<
      SponsorshipMintedEvent.InputTuple,
      SponsorshipMintedEvent.OutputTuple,
      SponsorshipMintedEvent.OutputObject
    >;
